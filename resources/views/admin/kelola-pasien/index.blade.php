                                ...
                                <tbody class="divide-y divide-gray-200 dark:divide-neutral-700">
                                    @forelse ($pasiens as $pasien)
                                        <tr class="hover:bg-gray-100 dark:hover:bg-neutral-700">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 dark:text-neutral-200">
                                                {{ $pasien->alamat }} <!-- Alamat Pasien -->
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 dark:text-neutral-200">
                                                {{ $pasien->no_ktp }} <!-- No KTP Pasien -->
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 dark:text-neutral-200">
                                                {{ $pasien->no_hp }} <!-- No HP Pasien -->
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 dark:text-neutral-200">
                                                {{ $pasien->no_rm }} <!-- No Rekam Medis Pasien -->
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 dark:text-neutral-200">
                                    ...
                                    @empty
                                        <tr class="hover:bg-gray-100 dark:hover:bg-neutral-700">
                                            <td colspan="7"
                                                class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 dark:text-neutral-200 text-center">
