                    ...
                    <div class="p-1.5 min-w-full inline-block align-middle">
                        <div
                            ...
                            <div class="p-4 overflow-y-auto">
                                <form action="{{ route('admin.kelola-obat.save') }}" method="POST">
                                    @csrf
                                    <div class="mb-4">
                                        <label for="nama_obat" class="block text-gray-800 dark:text-neutral-400">Nama
                                            Obat</label>
                                        <input type="text" id="nama_obat" name="nama_obat"
                                            class="mt-2 px-4 py-2 w-full border border-gray-200 rounded-lg" required placeholder="Nama Obat">
                                    </div>
                                    <div class="mb-4">
                                        <label for="kemasan"
                                            class="block text-gray-800 dark:text-neutral-400">Kemasan</label>
                                        <textarea id="kemasan" name="kemasan" class="mt-2 px-4 py-2 w-full border border-gray-200 rounded-lg" rows="4" placeholder="Kemasan"></textarea>
                                    </div>
                                    <div class="mb-4">
                                        <label for="harga"
                                            class="block text-gray-800 dark:text-neutral-400">Harga</label>
                                            <input type="number" id="harga" name="harga"
                                            class="mt-2 px-4 py-2 w-full border border-gray-200 rounded-lg" required placeholder="Harga">
                                    </div>
                                    <div
